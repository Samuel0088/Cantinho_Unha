// Adiciona o evento de clique para imagens com a classe "zoomable-image"
    document.querySelectorAll('.zoomable-image').forEach(img => {
        img.addEventListener('click', function () {
            // Verifica se a imagem já está com zoom
            if (this.classList.contains('zoomed')) {
                this.classList.remove('zoomed');
            } else {
                // Remove o zoom de outras imagens e aplica à imagem clicada
                document.querySelectorAll('.zoomable-image').forEach(otherImg => {
...
var CELULAR_EMPRESA = "5519999109945";
